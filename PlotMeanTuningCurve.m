...
%% Plot mean tuning curve for whisker responsive cells
...
errorbar([1:6], nanmean(meanranktc(sig_inds_w,1:6),1),  nansem(meanranktc(sig_inds_w,1:6),1),'k-', 'LineWidth', 2, 'color', 'k', 'MarkerSize', 2)
